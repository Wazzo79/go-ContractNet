...
// Welcome show summary of current GContractNet instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic GContractNet metadata
	fmt.Fprintf(c.printer, "Welcome to the GContractNet JavaScript console!\n\n")
	c.jsre.Run(`
