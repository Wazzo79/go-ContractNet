...
import (
	...
	"github.com/ContractNetLabs/go-ContractNet/eth/filters"
	"github.com/ContractNetLabs/go-ContractNet/eth/gasprice"
	...
	"github.com/ContractNetLabs/go-ContractNet/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		...
		if bcVersion != core.BlockChainVersion && bcVersion != 0 {
			return nil, fmt.Errorf("Blockchain DB version mismatch (%d / %d). Run gContractNet upgradedb.\n", bcVersion, core.BlockChainVersion)
		}
