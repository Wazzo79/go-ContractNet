...
# 1. install gContractNet for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gContractNet
# 5. create gContractNet, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gContractNet is installed global
