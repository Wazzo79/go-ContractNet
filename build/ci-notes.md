...
people to build go-ContractNet using the standard toolchain without any particular package
...
To allow reproducible builds of go-ContractNet nonetheless that don't need network access
...
We want to build go-ContractNet with the most recent version of Go, irrespective of the Go
