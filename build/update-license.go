...
var (
	...
	authorsFileHeader = "# This is the official list of go-ContractNet authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ContractNet Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-ContractNet"
	}
	if startOfSentence {
		return "The go-ContractNet library"
	}
	return "the go-ContractNet library"
}
